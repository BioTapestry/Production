...
public class ExportSettingsPublishDialogFactory extends DialogFactory {
  ...
  */ 
  ...
  public ExportSettingsPublishDialogFactory(ServerControlFlowHarness cfh) {
    super(cfh);
  }  
  ...
  */  
  ...
  public ServerControlFlowHarness.Dialog getDialog(DialogBuildArgs ba) { 
    ...
    if (platform.getPlatform() == DialogPlatform.Plat.DESKTOP) {
      return (new DesktopDialog(cfh, dniba.baseWidth, dniba.baseHeight));
    }
  ...
  public static class BuildArgs extends DialogBuildArgs { 
    ...
    public BuildArgs(Genome genome, int baseWidth, int baseHeight) {
      super(genome);
  ...
  public static class DesktopDialog extends JDialog implements DesktopDialogPlatform.Dialog { 
    ...
    private enum ParamVals {NONE_, ZOOM_, HEIGHT_, WIDTH_, ASPECT_, RES_};
        ...
        public void actionPerformed(ActionEvent ev) {
          try {
            if (extractProperties()) {
              cfh_.sendUserInputs(finishedSettings_);
    ...
    */
    ...
    private void processPublishVal(boolean force, ParamVals whichVal) {
        ...
        if (whichVal == ParamVals.ZOOM_) {
          ...
          if (!zoomText.equals("") && !zoomText.equals(".")) {
            try {
              ...
              if (haveZoom && tooBigOrSmall(newZoom, ParamVals.ZOOM_)) {
    ...
    */
    ...
    private void setFields(ParamVals whichVal, double newZoom, double newHeight, double newWidth,
    ...
    */
    ...
    private boolean tooBigOrSmall(double newVal, ParamVals whichVal) {
      //
    ...
    */
    ...
    private JPanel buildPublishPanel(int baseWidth, int baseHeight, List<String> types) {
    ...
    */
    ...
    private class PublishListener implements ActionListener, CaretListener, FocusListener {
      ...
      PublishListener(ParamVals whichVal) {
        whichVal_ = whichVal;
      }
