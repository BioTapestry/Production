...
public class SuggestedDrawStylePanel extends JPanel {
  ...
  */ 
  ...
  public SuggestedDrawStylePanel(UIComponentSource uics, ColorResolver cRes, HarnessBuilder hBld, boolean optional) {   
    this(uics, cRes, hBld, false, optional, false, null);
  }
  ...
  */ 
  ...
  public SuggestedDrawStylePanel(UIComponentSource uics, ColorResolver cRes, HarnessBuilder hBld,
                                 boolean optional, List<ColorDeletionListener> colorListeners) { 
    this(uics, cRes, hBld, true, optional, false, colorListeners);
  }
  ...
  */ 
  ...
  public SuggestedDrawStylePanel(UIComponentSource uics, ColorResolver cRes, HarnessBuilder hBld,
    ...
    if (doColor_) {
      ...
      colorWidget_ = new ColorSelectionWidget(uics_, cRes_, hBld, colorListeners, !optional, null, true, forMulti);
    ...
    Vector<ChoiceContent> styleChoices = SuggestedDrawStyle.getStyleChoices(uics_.getRMan()); 
    if (forMulti) {
    ...
    Vector<ChoiceContent> thicknessChoices = SuggestedDrawStyle.getThicknessChoices(uics_.getRMan());
    if (forMulti) {
  ...
  */
  ...
  public void displayMultiProperties(SuggestedDrawStyle current, ConsensusLinkProps clp) {
    ...
    if (clp.consensusStyle == SuggestedDrawStyle.VARIOUS_STYLE) {
      ...
      styleCombo_.setSelectedItem(SuggestedDrawStyle.lineStyleForCombo(uics_.getRMan(), clp.consensusStyle));
    }
  
    if (clp.consensusThickness == SuggestedDrawStyle.VARIOUS_THICKNESS) {
      thicknessCombo_.setSelectedIndex(0);
    } else {          
      thicknessCombo_.setSelectedItem(SuggestedDrawStyle.thicknessForCombo(uics_.getRMan(), clp.consensusThickness));
    }
  ...
  */
  ...
  public void displayProperties(SuggestedDrawStyle current, SuggestedDrawStyle defaults) {
    ...
    styleCombo_.setSelectedItem(SuggestedDrawStyle.lineStyleForCombo(uics_.getRMan(), showStyle));
    ...
    thicknessCombo_.setSelectedItem(SuggestedDrawStyle.thicknessForCombo(uics_.getRMan(), showThickness));
    return;
  }
