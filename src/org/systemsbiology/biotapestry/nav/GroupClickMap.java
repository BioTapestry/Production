...
public class GroupClickMap {
  
  public int padNum;
  public double dot;

  public GroupClickMap(int padNum, double dot) {
    this.padNum = padNum;
    this.dot = dot;
  }
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GroupClickMap)) {
      return (false);
    }
    return (this.compareTo((GroupClickMap)other) == 0);
  }   

  public int compareTo(GroupClickMap other) {
