...
/****************************************************************************
**
** Interface for plugins that display experimental data.  This interface
** is being kept around for legacy reasons only!  Should now be using
** ExternalNodeDataDisplayPlugIn for new development!
*/

public interface ExternalDataDisplayPlugIn extends DataDisplayPlugIn {
