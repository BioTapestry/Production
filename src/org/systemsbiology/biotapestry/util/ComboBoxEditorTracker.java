...
public class ComboBoxEditorTracker implements ItemListener, ActionListener {
  ...
  */ 
  ...
  public ComboBoxEditorTracker(ComboBoxEditor comboEdit, AbstractTableModel table, HandlerAndManagerSource hams) {
    this(comboEdit, table, null, hams);
  }
    
  public ComboBoxEditorTracker(ComboBoxEditor comboEdit, AbstractTableModel table, ComboFinishedTracker finished, HandlerAndManagerSource hams) { 
