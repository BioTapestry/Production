...
public class TextEditorTracker implements CaretListener, CellEditorListener {
  ...
  */ 
  ...
  public TextEditorTracker(TextEditor textEdit, AbstractTableModel table, HandlerAndManagerSource hams) { 
    this(textEdit, table, null, hams);
  }
  
  public TextEditorTracker(TextEditor textEdit, AbstractTableModel table, TextFinishedTracker track, HandlerAndManagerSource hams) { 
    textEdit_ = textEdit;
    table_ = table;
    finished_ = track;
    hams_ = hams;
